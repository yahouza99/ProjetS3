          ...
          <div class="container-fluid my-2">
                ...
                <div class="row justify-content-center ">
                  ...
                  <div class="col-lg-6 text-center ">
                    <a href="/Project/ServletArticle?action=allarticle" ><h5 class=" mx-5" style="color: #594E83;" ><i class="fa-solid fa-film"></i> Films &  Series</h5></a>
                  </div> 
                  <div class="col-lg-6 text-center ">
                   <a href="/Project/ServletArticle?action=allarticle2"> <h5 class=" mx-5" ><i class="fa-solid fa-music"></i> Musiques</h5></a>
                  </div>
                  <!-- col end -->
                </div>
                <!-- row end -->
