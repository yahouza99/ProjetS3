            ...
            <div id="scrollbar2" class="art-scroll-frame">
              ...
              <nav id="swupMenu">
                ...
                <ul class="main-menu" style="list-style-type: none; font-size: 20px;">
                  ...
                  <!-- menu item -->
                  <li class="menu-item mb-1"><a href="/Project/ServletArticle?action=allarticle" style="color:white;"><i class="fa-solid fa-rectangle-list"></i>  Articles</a></li>
                  <!-- menu item -->
          ...
          <div class="container-fluid my-2">
                ...
                <div class="row justify-content-center ">
                  ...
                  <div class="col-lg-6 text-center ">
                    <a href="/Project/ServletArticle?action=allarticle" ><h5 class=" mx-5"  ><i class="fa-solid fa-film"></i> Films & Series</h5></a>
                  </div>
                  <div class="col-lg-6 text-center ">
                   <a href="/Project/ServletArticle?action=allarticle2"> <h5 class=" mx-5" style="color: #594E83;"><i class="fa-solid fa-music"></i> Musiques</h5></a>
                  </div>
                  <!-- col end -->
                </div>
                <!-- row end -->
              ...
              <div class="container-fluid mt-3">
                ...
                <c:forEach var="titre" items="${listtitres}"  varStatus="boucle">
                  <div class="card m-1" style="width: 8rem;">
                    ...
                    <h6 class="card-subtitle  text-muted"><c:out value="${titre.getId_celeb()}" /></h6>
