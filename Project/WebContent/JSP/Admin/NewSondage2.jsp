          ...
          <div class="container-fluid">
                ...
                <div class="row justify-content-center ">
                  ...
                  <div class="col-lg-12 text-center">
                    <h3 class=" mx-5">Nouveau Sondage de Titres</h3>
                  </div>
            ...
            <div id="scrollbar" class="art-scroll-frame">
              ...
              <div class="container-fluid mt-2">
                ...
                <div class="row adm-row justify-content-center">
                    <form method="post" action="/Project/ServletSondage?action=insertsondage_t" style="border:1px solide red;">
                   <div class="mb-3">
                    <select class="form-control" name="id1">
                        <c:forEach var="titre" items="${listtitres}"  varStatus="boucle">
                            <option value="<c:out value="${titre.getIdtitre() }" />"><c:out value="${titre.getLabel_titre()}" /></option>                       
                         </c:forEach>
                   </select>
                   </div>
                   <div class="mb-3">
