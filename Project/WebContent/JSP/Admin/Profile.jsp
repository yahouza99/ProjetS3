            ...
            <div id="scrollbar" class="art-scroll-frame">
              ...
              <div class="container-fluid mt-2">
                ...
                <table class="table" border style="font-size:17px">
                        ...
                        <tbody>
                              <tr>
                              <td align="center"> <img src="<c:out value="${fan.getPhoto()}" />" class="card-img-top" alt="Photo"></td>
                              <td align="center" class="text-white">
                              <table >
                              <tr><td class="text-info">Nom :</td><td> <c:out value="${fan.getNom()}" /></td></tr>
                               <tr><td class="text-info"> Prenom:</td><td>  <c:out value="${fan.getPrenom()}" /></td></tr>
                                <tr><td class="text-info">Login:</td><td> <c:out value="${fan.getLogin()}" /></td></tr>
                                <tr><td class="text-info"> Password:</td><td>  <c:out value="${fan.getPassword()}" /></td></tr>
                              </table>
                              </td>
                              </tr>
                        </tbody>
                ...
                <table class="table" border style="font-size:17px">
                        ...
                        <tbody>
                              <tr>
                              <td align="center"> <img src="<c:out value="${celeb.getPhoto()}" />" class="card-img-top" alt="Photo"></td>
                              <td align="center" class="text-white">
                              <table >
                              <tr><td class="text-info">Nom :</td><td> <c:out value="${celeb.getNom()}" /></td></tr>
                               <tr><td class="text-info"> Prenom:</td><td>  <c:out value="${celeb.getPrenom()}" /></td></tr>
                                <tr><td class="text-info">Login:</td><td> <c:out value="${celeb.getLogin()}" /></td></tr>
                                <tr><td class="text-info"> Password:</td><td>  <c:out value="${celeb.getPassword()}" /></td></tr>
                              </table>
                              </td>
                              </tr>
                              <tr>
                              <td align="center" colspan="2">
                              <a class="text-info" href="<c:out value='${celeb.getInsta()}' />"><i class="fa-brands fa-instagram"></i></a>
                              <a class="text-info" href="<c:out value='${celeb.getFacebook()}' />"><i class="fa-brands fa-facebook"></i></a>
                              <a class="text-info" href="<c:out value='${celeb.getTwiter()}' />"><i class="fa-brands fa-twitter"></i></a>
                              </td></tr>
                        </tbody>
                      </table>
                </c:if>
