                ...
                <div class="row">
                  ...
                  <table class="table" border style="font-size:17px">
                        ...
                        <tbody>
                              ...
                              <td align="center"> <img src="<c:out value="${demande.getContenu()}" />"  alt="Photo" height="200px"><br>
                              ...
                              <td>
                              <video src="/Project/WebContent/images/vd1.mp4"></video><br>
                               <a class="text-danger" href="/Project/ServletDemande?action=deletedemande&d=1&id=<c:out value='${demande.getIddemande()}'/>">
                                       Telecharger</a>
                                </td>
                              </c:if> 
