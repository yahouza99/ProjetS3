            ...
            <div id="scrollbar2" class="art-scroll-frame">
              ...
              <div class="art-table p-15-15">
                ...
                <ul>
                  ...
                  <li>
                    <h4><a href="/Project/ServletDemande?action=alldemande&m=1" style="color:white">Demandes</a><h4>
                  </li>
                  <li>
            ...
            <div id="scrollbar" class="art-scroll-frame">
              ...
              <div class="container-fluid">
                ...
                <div class="row">
                  ...
                  <!-- col end -->
                  <!-- col -->
                  <table class="table text-white mt-4" border>
                        <thead>
                          <tr>
                          ...
                          <tr>
                                    ...
                                    <td>
                                       <c:forEach var="celeb" items="${listcelebs}"  varStatus="boucle2">
                                        ...
                                        <c:out value="${celeb.getPrenom()}" />  <c:out value="${celeb.getNom()}" />    
                                        </c:if>
                                      </c:forEach>
                                    </td>
                                    <td>
                                    ...
                                    <td><a class="text-info" href="/Project/ServletDemande?action=finddemande&u=1&id=<c:out value='${demande.getIddemande()}'/>&idf=<c:out value='${demande.getIdf()}'/>&idc=<c:out value='${demande.getIdc()}'/>">
                                       <i class="fa-solid fa-pen"></i></a> 
                                       |<a class="text-danger" href="/Project/ServletDemande?action=deletedemande&d=1&id=<c:out value='${demande.getIddemande()}'/>">
