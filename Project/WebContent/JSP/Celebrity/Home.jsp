                                                ...
                                                <div class="profile-body"><!-- profile body section -->
                                                    ...
                                                    <div class="account-info">
                                                        <div class="data">
                                                            <div class="important-data">
                                                                <section class="data-item">
                                                                    ...
                                                                    <small class="value">Movies</small>
                                                                </section>
                                                                <section class="data-item">
                                                                    <h3 class="value">3</h3>
                                                                    <small class="value">Demandes</small>
                                                                </section>
                                                                </section>
                                                                <section class="data-item">
                                                                    <h3 class="value">1</h3>
                                                                    <small class="value">Repondues</small>
                                                                </section>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="social-media">
                                                            ...
                                                            <a href="${celeb.getFacebook()}" class="media-link"><i
                                                                    class="fab fa-facebook-square"></i></a>
                                                            <a href="<c:out value="${celeb.getTwiter()}"/>"
                                                                class="media-link"><i
                                                                    class="fab fa-twitter-square"></i></a>
                                                            <a href="<c:out value="${celeb.getInsta()}"/>"
                                                                class="media-link"><i
